...
È lo sviluppo di Taylor della distribuzione di temperatura $T$ al variare dell'angolo $\B\theta$ bidimensionale al secondo ordine. 
...
\begin{figure}[ht]
    ...
    \caption{Confronto tra $C_{TT}$ con e senza le correzioni di lensing.}
\end{figure}
